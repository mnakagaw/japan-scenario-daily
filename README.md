...
- 世界の横断変数：海峡・運河、供給、原油、制裁・決済、物価・金融、食料・肥料・農業（9月16日号から）の観測値・状態・変化
- 日付比較・アーカイブ：公開済みの日付だけを表示
- 方法・訂正履歴、RSS、Markdown/JSON保存、印刷

日報作成は2026年9月16日から毎日16:30（日本時間）に開始します。9月13〜15日の15:30開始号は過去の実行記録として保持します。調査・分析・検査後、GitHubへの保存とGitHub Pagesの公開確認まで実施します。11月4日16:30の最終回は日報と総括を兼ねます。16時30分は公開完了時刻ではありません。
...
9月16日号から、`food-security-monitoring.json` に基づいて食料安全保障、肥料価格・供給、主要作物の作柄・収穫見通し、需給・在庫、輸出規制も毎日確認します。世界の横断変数「食料・肥料・農業」として扱い、日本の農業生産費、食料・飼料の調達、食品価格・供給への影響を①〜④に組み込みます。窒素・リン酸・カリ肥料、現物・先物、通貨・品位・受渡条件、収穫年・販売年度、予測・実績を分け、月次資料は公表日と対象期を表示します。比較元が異なる価格差や、作柄評価比率からの生産量を作りません。重要な更新や確認できた重大制約を掲載し、取得不足は明示します。「読み方」に確認対象と一次情報の入口を示します。
